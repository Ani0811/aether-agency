            ...
            >
              ...
              <div className="relative z-10 grow flex flex-col">
                ...
                <div className="flex items-baseline gap-2 mb-2">
                  <span className="text-4xl font-black tracking-tighter text-(--text-primary) group-hover:text-purple-500 transition-colors duration-300">{plan.price}</span>
                  <span className="text-sm font-medium text-(--text-muted) transition-colors duration-300 group-hover:text-purple-400">{plan.period}</span>
                </div>
                ...
                <div className="space-y-4 mb-10 grow">
                  {plan.features.map((feature) => (
                    <div key={feature} className="flex items-center gap-3 text-sm" style={{ color: 'var(--text-secondary)' }}>
                      <div className="w-5 h-5 rounded-full bg-purple-500/20 flex items-center justify-center shrink-0p-hover:bg-purple-500/30 transition-colors">
                ...
                <button 
                  ...
                  className="w-full py-4 text-sm font-bold rounded-full transition-all duration-300 bg-transparent border border-gray-500/30 hover:border-purple-500/50 hover:bg-purple-500/5 text-(--text-primary)"
                >
